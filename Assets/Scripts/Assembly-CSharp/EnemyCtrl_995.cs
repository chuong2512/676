...
public class EnemyCtrl_995 : EnemyBaseCtrl
{
	[SerializeField]
	...
	{
		base.InitComponent();
		EnemyAttr enemyAttr = new EnemyAttr(DataManager.Instance.GetEnemyAttr("Monster_995"));
		enemyEntity = new Enemy_995(enemyAttr, this);
	...
	{
		Monster995AnimCtrl monster995AnimCtrl = (Monster995AnimCtrl)enemyAnimCtrl;
		if (monster995AnimCtrl.isInitOver)
		{
			monster995AnimCtrl.IdleAnim();
		}
	}
}
