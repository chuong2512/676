...
public class EnemyCtrl_36 : EnemyBaseCtrl
{
	[SerializeField]
	...
	{
		base.InitComponent();
		EnemyAttr enemyAttr = new EnemyAttr(DataManager.Instance.GetEnemyAttr("Monster_36"));
		enemyEntity = new Enemy_36(enemyAttr, this);
