...
public class EnemyCtrl_40 : EnemyBaseCtrl
{
	[SerializeField]
	...
	protected override void InitComponent()
	{
		...
		EnemyAttr enemyAttr = new EnemyAttr(DataManager.Instance.GetEnemyAttr("Monster_40"));
		enemyEntity = new Enemy_40(enemyAttr, this);
		enemyAttr.SetEnemyBase(enemyEntity);
	}

	public void SetIdleAnim()
	{
		((Monster40AnimCtrl)enemyAnimCtrl).IdleAnim();
	}

	public void AtoBAnim()
	{
		((Monster40AnimCtrl)enemyAnimCtrl).AtoBAnim();
	}

	public void BtoAAnim()
	{
		((Monster40AnimCtrl)enemyAnimCtrl).BtoAAnim();
	}
