namespace Steamworks
{
	public static class SteamGameServer
	{
		public static bool InitGameServer(uint unIP, ushort usGamePort, ushort usQueryPort, uint unFlags, AppId_t nGameAppId, string pchVersionString)
		{
			...
			InteropHelp.UTF8StringHandle pchVersionString2 = new InteropHelp.UTF8StringHandle(pchVersionString);
		...
		{
			InteropHelp.TestIfAvailableGameServer();
			InteropHelp.UTF8StringHandle pszProduct2 = new InteropHelp.UTF8StringHandle(pszProduct);
		...
		{
			InteropHelp.TestIfAvailableGameServer();
			InteropHelp.UTF8StringHandle pszGameDescription2 = new InteropHelp.UTF8StringHandle(pszGameDescription);
		...
		{
			InteropHelp.TestIfAvailableGameServer();
			InteropHelp.UTF8StringHandle pszModDir2 = new InteropHelp.UTF8StringHandle(pszModDir);
		...
		{
			InteropHelp.TestIfAvailableGameServer();
			InteropHelp.UTF8StringHandle pszToken2 = new InteropHelp.UTF8StringHandle(pszToken);
		...
		{
			InteropHelp.TestIfAvailableGameServer();
			InteropHelp.UTF8StringHandle pszServerName2 = new InteropHelp.UTF8StringHandle(pszServerName);
		...
		{
			InteropHelp.TestIfAvailableGameServer();
			InteropHelp.UTF8StringHandle pszMapName2 = new InteropHelp.UTF8StringHandle(pszMapName);
		...
		{
			InteropHelp.TestIfAvailableGameServer();
			InteropHelp.UTF8StringHandle pszSpectatorServerName2 = new InteropHelp.UTF8StringHandle(pszSpectatorServerName);
		...
		{
			InteropHelp.TestIfAvailableGameServer();
			InteropHelp.UTF8StringHandle pchGameTags2 = new InteropHelp.UTF8StringHandle(pchGameTags);
		...
		{
			InteropHelp.TestIfAvailableGameServer();
			InteropHelp.UTF8StringHandle pchGameData2 = new InteropHelp.UTF8StringHandle(pchGameData);
		...
		{
			InteropHelp.TestIfAvailableGameServer();
			InteropHelp.UTF8StringHandle pszRegion2 = new InteropHelp.UTF8StringHandle(pszRegion);
		...
		{
			InteropHelp.TestIfAvailableGameServer();
			InteropHelp.UTF8StringHandle pchPlayerName2 = new InteropHelp.UTF8StringHandle(pchPlayerName);
