...
public class EnemyCtrl_24 : EnemyBaseCtrl
{
	[SerializeField]
	...
	{
		base.InitComponent();
		EnemyAttr enemyAttr = new EnemyAttr(DataManager.Instance.GetEnemyAttr("Monster_24"));
		enemyEntity = new Enemy_24(enemyAttr, this);
