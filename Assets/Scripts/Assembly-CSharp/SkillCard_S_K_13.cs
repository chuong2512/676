...
public class SkillCard_S_K_13 : SkillCard
{
	...
	public SkillCard_S_K_13(SkillCardAttr skillCardAttr)
		: base(skillCardAttr)
	{
	...
	private void Effect(Player player, Action handler)
	{
		...
		{
			gameReportUI.AddGameReportContent(base.CardName + "效果触发：玩家获得3层守护光环buff");
		}
		player.GetBuff(new Buff_ProtectHalo(player, 3));
		handler?.Invoke();
	}
