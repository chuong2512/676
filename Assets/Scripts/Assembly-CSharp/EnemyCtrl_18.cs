...
public class EnemyCtrl_18 : EnemyBaseCtrl
{
	[SerializeField]
	...
	{
		base.InitComponent();
		EnemyAttr enemyAttr = new EnemyAttr(DataManager.Instance.GetEnemyAttr("Monster_18"));
		enemyEntity = new Enemy_18(enemyAttr, this);
	...
	public void Action3Anim(int atkTime, Transform[] targets, Action<int> effect, Action actionOver)
	{
		ActionAnim(Action3Config, atkTime, targets, effect, actionOver);
	}
}
