...
public class EnemyCtrl_59 : EnemyBaseCtrl
{
	[SerializeField]
	...
	{
		base.InitComponent();
		EnemyAttr enemyAttr = new EnemyAttr(DataManager.Instance.GetEnemyAttr("Monster_59"));
		enemyEntity = new Enemy_59(enemyAttr, this);
	...
	public void Action3Anim(Transform[] targets, Action<int> effect, Action actionOver)
	{
		ActionAnim(Action3Config, 3, targets, effect, actionOver);
	}
