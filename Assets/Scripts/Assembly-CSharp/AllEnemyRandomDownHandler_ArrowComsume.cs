...
public class AllEnemyRandomDownHandler_ArrowComsume : AllEnemyDownHandler_ArrowComsume
{
	public AllEnemyRandomDownHandler_ArrowComsume(int hintArrowAmount, bool isDrop)
		: base(hintArrowAmount, isDrop)
	{
	}
