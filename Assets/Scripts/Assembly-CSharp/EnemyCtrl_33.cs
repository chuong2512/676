...
public class EnemyCtrl_33 : EnemyBaseCtrl
{
	[SerializeField]
	...
	{
		base.InitComponent();
		EnemyAttr enemyAttr = new EnemyAttr(DataManager.Instance.GetEnemyAttr("Monster_33"));
		enemyEntity = new Enemy_33(enemyAttr, this);
