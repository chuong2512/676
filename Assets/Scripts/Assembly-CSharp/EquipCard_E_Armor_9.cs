public class EquipCard_E_Armor_9 : EquipCard_E_Armor
{
	private class BattleEffect_E_Armor_9 : BaseBattleEffect
	{
		private const string EquipNameKey = "E_Armor_9_Name";
		...
		{
			IntData = 5;
			source = "E_Armor_9_Name".LocalizeText();
		}
	}

	private BaseBattleEffect battleEffect;

	public EquipCard_E_Armor_9(EquipmentCardAttr equipmentCardAttr)
		: base(equipmentCardAttr)
	{
		battleEffect = new BattleEffect_E_Armor_9();
	}
