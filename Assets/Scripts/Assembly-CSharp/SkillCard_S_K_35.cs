...
public class SkillCard_S_K_35 : SkillCard
{
	...
	public SkillCard_S_K_35(SkillCardAttr skillCardAttr)
		: base(skillCardAttr)
	{
	...
	private void Effect(Player player, Action handler)
	{
		...
		{
			gameReportUI.AddGameReportContent(base.CardName + "效果触发：玩家获得1点力量");
		}
