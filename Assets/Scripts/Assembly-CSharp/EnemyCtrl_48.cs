...
public class EnemyCtrl_48 : EnemyBaseCtrl
{
	[SerializeField]
	...
	{
		base.InitComponent();
		EnemyAttr enemyAttr = new EnemyAttr(DataManager.Instance.GetEnemyAttr("Monster_48"));
		enemyEntity = new Enemy_48(enemyAttr, this);
