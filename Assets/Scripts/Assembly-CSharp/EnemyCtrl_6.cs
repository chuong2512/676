...
public class EnemyCtrl_6 : EnemyBaseCtrl
{
	[SerializeField]
	...
	{
		base.InitComponent();
		EnemyAttr enemyAttr = new EnemyAttr(DataManager.Instance.GetEnemyAttr("Monster_6"));
		enemyEntity = new Enemy_6(enemyAttr, this);
	...
	public void Action2Anim(int amount, Transform[] targets, Action<int> effect, Action actionOver)
	{
		EnemyBaseCtrl.BubbleTalk(Action2BubbleKeys, bubblePoint);
		ActionAnim((amount == 0) ? null : Action2Config, amount, targets, effect, actionOver);
	}
