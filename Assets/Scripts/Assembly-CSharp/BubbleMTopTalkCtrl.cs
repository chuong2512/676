...
public class BubbleMTopTalkCtrl : MonoBehaviour
{
	...
	public void ShowMTopBubble(string content, BubbleTalkUI bubbleTalkUi)
	{
		...
		mTopCor = StartCoroutine(BubbleCounter_IE(HideMTopBubble));
	...
	private void HideMTopBubble()
	{
		base.gameObject.SetActive(value: false);
		_bubbleTalkUi.RecycleMTopBubble(this);
	}
}
