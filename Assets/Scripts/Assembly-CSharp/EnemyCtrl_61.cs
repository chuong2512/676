...
public class EnemyCtrl_61 : EnemyBaseCtrl
{
	[SerializeField]
	...
	{
		base.InitComponent();
		EnemyAttr enemyAttr = new EnemyAttr(DataManager.Instance.GetEnemyAttr("Monster_61"));
		enemyEntity = new Enemy_61(enemyAttr, this);
