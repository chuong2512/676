...
public class EnemyCtrl_13 : EnemyBaseCtrl
{
	[SerializeField]
	...
	{
		base.InitComponent();
		EnemyAttr enemyAttr = new EnemyAttr(DataManager.Instance.GetEnemyAttr("Monster_13"));
		enemyEntity = new Enemy_13(enemyAttr, this);
	...
	public void Action4Anim(Transform[] targets, Action<int> effect, Action actionOver)
	{
		ActionAnim(Action4Config, 3, targets, effect, actionOver);
	}
}
