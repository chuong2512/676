...
public class SkillCard_S_A_45 : SkillCard_Archer
{
	private int realDmg;
	...
	public SkillCard_S_A_45(SkillCardAttr skillCardAttr)
		: base(skillCardAttr)
	{
	...
	private int RealDmg(Player player, out string atkDes)
	{
		...
		atkDes = BaseCard.GetRealDamageAtkDes(player, $"单倍武器伤害({player.PlayerAttr.AtkDmg * 2})", IntData, out var pwdBuff, out var rate);
