...
namespace Spine
{
	public static class SkeletonExtensions
	{
		...
		{
			skeleton.data.FindAnimation(animationName)?.Apply(skeleton, 0f, time, loop, null, 1f, MixBlend.Setup, MixDirection.In);
		}
		...
		{
			animation.Apply(skeleton, 0f, 0f, loop: false, null, 0f, MixBlend.Setup, MixDirection.Out);
		}
