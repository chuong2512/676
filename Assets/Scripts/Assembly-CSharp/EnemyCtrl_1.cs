...
public class EnemyCtrl_1 : EnemyBaseCtrl
{
	[SerializeField]
	...
	{
		base.InitComponent();
		EnemyAttr enemyAttr = new EnemyAttr(DataManager.Instance.GetEnemyAttr("Monster_1"));
		enemyEntity = new Enemy_1(enemyAttr, this);
