...
public class SkillCard_S_K_14 : SkillCard
{
	...
	public SkillCard_S_K_14(SkillCardAttr skillCardAttr)
		: base(skillCardAttr)
	{
	...
	private void Effect(Player player, Action handler)
	{
		...
		{
			gameReportUI.AddGameReportContent(base.CardName + "效果触发：玩家获得3层惩戒光环buff");
		}
		player.GetBuff(new Buff_PunishmentHalo(player, 3));
		handler?.Invoke();
	}
