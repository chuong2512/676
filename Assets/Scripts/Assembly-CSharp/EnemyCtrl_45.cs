...
public class EnemyCtrl_45 : EnemyBaseCtrl
{
	[SerializeField]
	...
	{
		base.InitComponent();
		EnemyAttr enemyAttr = new EnemyAttr(DataManager.Instance.GetEnemyAttr("Monster_45"));
		enemyEntity = new Enemy_45(enemyAttr, this);
