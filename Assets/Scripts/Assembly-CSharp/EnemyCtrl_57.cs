...
public class EnemyCtrl_57 : EnemyBaseCtrl
{
	[SerializeField]
	...
	{
		base.InitComponent();
		EnemyAttr enemyAttr = new EnemyAttr_57(DataManager.Instance.GetEnemyAttr("Monster_57"));
		enemyEntity = new Enemy_57(enemyAttr, this);
	...
	public void Action5Anim(Transform[] targets, int time, Action<int> effect, Action actionOver)
	{
		ActionAnim(Action5Config, time, targets, effect, actionOver);
	}

	public void Action6Anim(Transform[] targets, int time, Action<int> effect, Action actionOver)
	{
