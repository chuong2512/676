...
public class EnemyCtrl_0 : EnemyBaseCtrl
{
	[SerializeField]
	...
	{
		base.InitComponent();
		EnemyAttr enemyAttr = new EnemyAttr(DataManager.Instance.GetEnemyAttr("Monster_0"));
		enemyEntity = new Enemy_0(enemyAttr, this);
	...
	{
		ActionAnim(Action1Config, 2, targets, effect, actionOver);
	}
	...
	{
		Monster0AnimCtrl monster0AnimCtrl = (Monster0AnimCtrl)enemyAnimCtrl;
		if (monster0AnimCtrl.isInitOver)
		{
			monster0AnimCtrl.IdleAnim();
		}
	}
}
