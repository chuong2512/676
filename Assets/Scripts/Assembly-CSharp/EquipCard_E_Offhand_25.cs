public class EquipCard_E_Offhand_25 : EquipCard_E_Offhand
{
	private class EquipCard_E_Offhand_25_BattleEffect : BaseBattleEffect
	{
		...
		public override void TakeEffect(BattleEffectData data, out int IntData)
		{
			...
			if ((simpleEffectData = data as SimpleEffectData) != null && simpleEffectData.intData == 2)
			{
				IntData = 3;
			}
			else
	...
	private EquipCard_E_Offhand_25_BattleEffect _battleEffect;

	public EquipCard_E_Offhand_25(EquipmentCardAttr equipmentCardAttr)
		: base(equipmentCardAttr)
	{
		_battleEffect = new EquipCard_E_Offhand_25_BattleEffect();
	}
