...
public class SkillCard_S_K_36 : SkillCard
{
	...
	public SkillCard_S_K_36(SkillCardAttr skillCardAttr)
		: base(skillCardAttr)
	{
	...
	private void Effect(Player player, Action handler)
	{
		...
		{
			gameReportUI.AddGameReportContent(base.CardName + "效果触发：玩家获得2回合的圣佑buff");
		}
		player.GetBuff(new Buff_ShengYou(player, 2));
		handler?.Invoke();
	}
