...
public class EnemyCtrl_997 : EnemyBaseCtrl
{
	[SerializeField]
	...
	{
		base.InitComponent();
		EnemyAttr enemyAttr = new EnemyAttr(DataManager.Instance.GetEnemyAttr("Monster_997"));
		enemyEntity = new Enemy_997(enemyAttr, this);
	...
	{
		ActionAnim(Action2Config, amount, targets, effect, actionOver);
	}
}
