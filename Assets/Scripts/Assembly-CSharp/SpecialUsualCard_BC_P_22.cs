...
public class SpecialUsualCard_BC_P_22 : SpecialUsualCard
{
	protected override PointDownHandler pointdownHandler { get; }

	protected override PointUpHandler pointupHandler { get; }

	public SpecialUsualCard_BC_P_22(UsualCardAttr usualCardAttr)
		: base(usualCardAttr)
	{
	...
	private void Effect(Player player, Action handler)
	{
		...
		{
			gameReportUI.AddGameReportContent(base.CardName + "效果触发：移除身上一个随机的负面效果");
		}
		handler?.Invoke();
	}
}
