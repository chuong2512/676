...
public class SpecialUsualCard_BC_P_29 : SpecialUsualCard
{
	protected override PointDownHandler pointdownHandler { get; }

	protected override PointUpHandler pointupHandler { get; }

	public SpecialUsualCard_BC_P_29(UsualCardAttr usualCardAttr)
		: base(usualCardAttr)
	{
	...
	private void Effect(Player player, EnemyBase enemyBase, Action handler)
	{
		...
		{
			player.PlayerAtkEnemy(enemyBase, 8, isTrueDmg: true);
		}
		GameReportUI gameReportUI = SingletonDontDestroy<UIManager>.Instance.GetView("GameReportUI") as GameReportUI;
		if (gameReportUI != null)
		{
			gameReportUI.AddGameReportContent(base.CardName + "效果触发：对" + enemyBase.EntityName + "造成10点真实伤害");
		}
		handler?.Invoke();
	}
}
