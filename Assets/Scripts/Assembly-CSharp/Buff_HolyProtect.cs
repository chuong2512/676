...
public class Buff_HolyProtect : BaseBuff
{
	public override BuffType BuffType => BuffType.Buff_HolyProtect;

	public Buff_HolyProtect(EntityBase entityBase, int round)
	...
	public override void HandleSameBuffAdd(BaseBuff baseBuff)
	{
		...
		{
			gameReportUI.AddGameReportContent(entityBase.EntityName + "的神圣庇护buff层数获得提升，当前的buff层数剩余：" + base.BuffRemainRound);
		}
	}
