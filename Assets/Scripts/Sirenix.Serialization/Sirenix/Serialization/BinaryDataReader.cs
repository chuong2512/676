			...
			fixed (byte* ptr5 = buffer)
			{
				fixed (char* ptr7 = text)
				{
					if (BitConverter.IsLittleEndian)
					{
						...
						while (ptr8 + 1 < ptr9)
						{
							Struct256Bit* ptr10 = ptr8;
							ptr8 = ptr10 + 1;
							Struct256Bit* intPtr = ptr10;
							ptr10 = ptr6;
							ptr6 = ptr10 + 1;
							*intPtr = *ptr10;
						}
						byte* ptr11 = (byte*)ptr6;
						byte* ptr12 = (byte*)ptr8;
						while (ptr12 < ptr9)
						{
							*(ptr12++) = *(ptr11++);
						}
					...
					{
						byte* ptr13 = ptr5 + bufferIndex;
						byte* ptr14 = (byte*)ptr7;
