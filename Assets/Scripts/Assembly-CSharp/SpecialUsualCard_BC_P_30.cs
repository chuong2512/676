...
public class SpecialUsualCard_BC_P_30 : SpecialUsualCard
{
	private int realDmg;
	...
	public SpecialUsualCard_BC_P_30(UsualCardAttr usualCardAttr)
		: base(usualCardAttr)
	{
	...
	public override string GetOnBattleDes(Player player, bool isMain)
	{
		...
		return string.Format(specialUsualCardAttr.DesKeyOnBattle.LocalizeText(), BaseCard.GetValueColor(3, num), num);
	}
