...
public class EnemyCtrl_21 : EnemyBaseCtrl
{
	[SerializeField]
	...
	{
		base.InitComponent();
		EnemyAttr enemyAttr = new EnemyAttr(DataManager.Instance.GetEnemyAttr("Monster_21"));
		enemyEntity = new Enemy_21(enemyAttr, this);
