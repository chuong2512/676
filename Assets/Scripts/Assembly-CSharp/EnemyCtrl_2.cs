...
public class EnemyCtrl_2 : EnemyBaseCtrl
{
	[SerializeField]
	...
	{
		base.InitComponent();
		EnemyAttr enemyAttr = new EnemyAttr(DataManager.Instance.GetEnemyAttr("Monster_2"));
		enemyEntity = new Enemy_2(enemyAttr, this);
	...
	{
		ActionAnim(Action2Config, 4, targets, effect, actionOver);
	}
