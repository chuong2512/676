...
public class UsualCard_BC_M_10 : UsualCard_Archer
{
	private int realDmg;
	...
	public UsualCard_BC_M_10(UsualCardAttr usualCardAttr)
		: base(usualCardAttr)
	{
	...
	private void Effect(Player player, EntityBase enTarget, Action handler)
	{
		...
		{
			gameReportUI.AddGameReportContent($"{base.CardName}效果触发：对{enTarget.EntityName}造成1次非真实的{realDmg}点伤害({atkDes}), 并施加1回合破甲");
		}
