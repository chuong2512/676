...
public class EnemyCtrl_44 : EnemyBaseCtrl
{
	[SerializeField]
	...
	{
		base.InitComponent();
		EnemyAttr enemyAttr = new EnemyAttr(DataManager.Instance.GetEnemyAttr("Monster_44"));
		enemyEntity = new Enemy_44(enemyAttr, this);
