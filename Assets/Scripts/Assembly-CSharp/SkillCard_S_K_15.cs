...
public class SkillCard_S_K_15 : SkillCard
{
	...
	public SkillCard_S_K_15(SkillCardAttr skillCardAttr)
		: base(skillCardAttr)
	{
	...
	private void Effect(Player player, Action handler)
	{
		...
		{
			gameReportUI.AddGameReportContent(base.CardName + "效果触发：玩家获得3层信仰光环buff");
		}
		player.GetBuff(new Buff_FaithHalo(player, 3));
		handler?.Invoke();
	}
