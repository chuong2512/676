...
public class EnemyCtrl_60 : EnemyBaseCtrl
{
	[SerializeField]
	...
	{
		base.InitComponent();
		EnemyAttr enemyAttr = new EnemyAttr(DataManager.Instance.GetEnemyAttr("Monster_60"));
		enemyEntity = new Enemy_60(enemyAttr, this);
