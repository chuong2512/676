...
public class SkillCard_S_A_37 : SkillCard_Archer
{
	private int realDmg;
	...
	public SkillCard_S_A_37(SkillCardAttr skillCardAttr)
		: base(skillCardAttr)
	{
	...
	private void Effect(Player player, EnemyBase enemyBase, Action handler)
	{
		...
		{
			int num = player.PlayerAtkEnemy(enemyBase, realDmg, isTrueDmg: false);
