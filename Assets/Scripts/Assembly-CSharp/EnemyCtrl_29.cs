...
public class EnemyCtrl_29 : EnemyBaseCtrl
{
	[SerializeField]
	...
	{
		base.InitComponent();
		EnemyAttr enemyAttr = new EnemyAttr(DataManager.Instance.GetEnemyAttr("Monster_29"));
		enemyEntity = new Enemy_29(enemyAttr, this);
