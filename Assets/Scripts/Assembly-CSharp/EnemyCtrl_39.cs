...
public class EnemyCtrl_39 : EnemyBaseCtrl
{
	[SerializeField]
	...
	{
		base.InitComponent();
		EnemyAttr enemyAttr = new EnemyAttr(DataManager.Instance.GetEnemyAttr("Monster_39"));
		enemyEntity = new Enemy_39(enemyAttr, this);
