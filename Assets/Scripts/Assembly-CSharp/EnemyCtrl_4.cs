...
public class EnemyCtrl_4 : EnemyBaseCtrl
{
	[SerializeField]
	...
	{
		base.InitComponent();
		EnemyAttr enemyAttr = new EnemyAttr(DataManager.Instance.GetEnemyAttr("Monster_4"));
		enemyEntity = new Enemy_4(enemyAttr, this);
