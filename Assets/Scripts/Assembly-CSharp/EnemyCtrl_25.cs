...
public class EnemyCtrl_25 : EnemyBaseCtrl
{
	[SerializeField]
	...
	{
		base.InitComponent();
		EnemyAttr enemyAttr = new EnemyAttr(DataManager.Instance.GetEnemyAttr("Monster_25"));
		enemyEntity = new Enemy_25(enemyAttr, this);
