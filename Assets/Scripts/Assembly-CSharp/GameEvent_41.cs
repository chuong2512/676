...
public class GameEvent_41 : BaseGameEvent
{
	public override string GameEventCode => "Event_41";
	...
	{
		EnemyHeapData specificEnemyHeap = DataManager.Instance.GetSpecificEnemyHeap("MHeap_100");
	...
	private void OnBattleEnd(EventData data)
	{
		...
		{
			BaseGameEvent.StartFollowEvent("Event_42", null);
			EventOver();
		}
