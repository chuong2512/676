...
namespace Steamworks
{
	public static class SteamMatchmaking
	{
		...
		{
			InteropHelp.TestIfAvailableClient();
			InteropHelp.UTF8StringHandle pchKeyToMatch2 = new InteropHelp.UTF8StringHandle(pchKeyToMatch);
			InteropHelp.UTF8StringHandle pchValueToMatch2 = new InteropHelp.UTF8StringHandle(pchValueToMatch);
