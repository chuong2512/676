...
public class EnemyCtrl_64 : EnemyBaseCtrl
{
	[SerializeField]
	...
	{
		base.InitComponent();
		EnemyAttr enemyAttr = new EnemyAttr(DataManager.Instance.GetEnemyAttr("Monster_64"));
		enemyEntity = new Enemy_64(enemyAttr, this);
	...
	{
		ActionAnim(Action3Config, 2, targets, effect, actionOver);
	}
}
