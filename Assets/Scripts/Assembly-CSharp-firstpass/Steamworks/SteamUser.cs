...
namespace Steamworks
{
	public static class SteamUser
	{
		...
		{
			InteropHelp.TestIfAvailableClient();
			InteropHelp.UTF8StringHandle pchExtraInfo2 = new InteropHelp.UTF8StringHandle(pchExtraInfo);
		...
		{
			InteropHelp.TestIfAvailableClient();
			InteropHelp.UTF8StringHandle pchRedirectURL2 = new InteropHelp.UTF8StringHandle(pchRedirectURL);
