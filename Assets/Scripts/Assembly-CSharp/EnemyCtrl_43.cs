...
public class EnemyCtrl_43 : EnemyBaseCtrl
{
	[SerializeField]
	...
	{
		base.InitComponent();
		EnemyAttr enemyAttr = new EnemyAttr(DataManager.Instance.GetEnemyAttr("Monster_43"));
		enemyEntity = new Enemy_43(enemyAttr, this);
	...
	{
		ActionAnim(Action2Config, 2, targets, effect, actionOver);
	}
}
