...
public class SkillCard_S_A_17 : SkillCard_Archer
{
	private int realDmg;
	...
	public SkillCard_S_A_17(SkillCardAttr skillCardAttr)
		: base(skillCardAttr)
	{
	...
	private void Effect(Player player, EntityBase target, Action handler)
	{
		...
		else
		{
			...
			SkillCard_Archer.ComsumeSpecialAttr(player, new EntityBase[1] { target }, 1, isDrop: false, 2);
		}
