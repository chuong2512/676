...
public class SkillCard_S_K_32 : SkillCard
{
	...
	public SkillCard_S_K_32(SkillCardAttr skillCardAttr)
		: base(skillCardAttr)
	{
	...
	private void Effect(Player player, EnemyBase enemyBase, Action handler)
	{
		...
		{
			gameReportUI.AddGameReportContent(base.CardName + "效果触发：减少" + enemyBase.EntityName + "2点力量");
		}
