...
public class EnemyCtrl_23 : EnemyBaseCtrl
{
	[SerializeField]
	...
	{
		base.InitComponent();
		EnemyAttr enemyAttr = new EnemyAttr(DataManager.Instance.GetEnemyAttr("Monster_23"));
		enemyEntity = new Enemy_23(enemyAttr, this);
