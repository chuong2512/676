...
public class EnemyCtrl_17 : EnemyBaseCtrl
{
	[SerializeField]
	...
	{
		base.InitComponent();
		EnemyAttr enemyAttr = new EnemyAttr(DataManager.Instance.GetEnemyAttr("Monster_17"));
		enemyEntity = new Enemy_17(enemyAttr, this);
	...
	public void Action2Anim(int atkTime, Transform[] targets, Action<int> effect, Action actionOver)
	{
		ActionAnim(Action2Config, atkTime, targets, effect, actionOver);
	}
