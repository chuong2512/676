...
public class UsualCard_BC_O_4 : UsualCard
{
	...
	public UsualCard_BC_O_4(UsualCardAttr usualCardAttr)
		: base(usualCardAttr)
	{
	...
	private void Effect(Player player, Action handler)
	{
		...
		{
			gameReportUI.AddGameReportContent(base.CardName + "效果触发：玩家获得1层稳固buff");
		}
		player.GetBuff(new Buff_Stable(player, 1));
		handler?.Invoke();
	}
